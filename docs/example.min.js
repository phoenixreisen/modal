(function () {
    ...
    var modalSizes;
    (function (modalSizes) {
        modalSizes["s7590"] = "modal--75-90";
        modalSizes["s9090"] = "modal--90-90";
        modalSizes["s5050"] = "modal--50-50";
        modalSizes["s5075"] = "modal--50-75";
    })(modalSizes || (modalSizes = {}));
    var Sizes = modalSizes;
    ...
    var Modal = {
        oninit: function (v) {
            ...
            document.addEventListener('keydown', function (e) {
                var _a;
                if (e.keyCode === 27) {
                    (_a = attrs.toggle) === null || _a === void 0 ? void 0 : _a.call(attrs);
                    mithril.redraw();
                }
            });
        },
        ...
        view: function (v) {
            var attrs = v.attrs;
            var content = attrs.content, footer = attrs.footer;
            var toggle = attrs.toggle, title = attrs.title, size = attrs.size, withCloseText = attrs.withCloseText;
            return ([
                mithril("article", { class: "modal modal--visible " + (size || '') },
                    mithril("div", { class: "modal__header" },
                        mithril("span", { class: "modal__headline" }, title || ''),
                        toggle &&
                            mithril("a", { class: "modal__toggle", href: "javascript:", onclick: toggle },
                                withCloseText && mithril("span", { class: "desktop-only" }, "schlie\u00DFen"),
                                mithril("i", { class: "fas fa-times-circle" }))),
                    mithril("div", { class: "modal__content" }, content || v.children),
                    footer &&
                        mithril("div", { class: "modal__footer tr" }, footer)),
                mithril("article", { class: "modal__bg" }),
            ]);
        },
    };
    ...
    var Item1 = {
        view: function () {
            return ([
                mithril("img", { src: "./phoenix-reisen-flotte.jpg", alt: "Phoenix Flotte", class: "img left" }),
                mithril("h3", { class: "pt0 mt0" }, "Gut geklickt, Brudi!"),
    ...
    var Demo = {
        ...
        view: function (_a) {
            var state = _a.state;
            return (mithril("div", { class: "modal-demo" },
                mithril("div", { class: "box" },
                    mithril("a", { href: "javascript:", onclick: function () { return state.show = true; }, title: "Modal aufrufen", class: "btn btn--link" }, "Klick mich!")),
                state.show &&
                    mithril(Modal$1, { title: "Modal Demo", withCloseText: true, toggle: function () { return (state.show = false); }, content: mithril("div", null,
                            mithril(Item1, null)), footer: mithril("div", { class: "tr" },
                            mithril("button", { class: "btn btn--secondary mr1", onclick: function () { return (state.show = false); } }, "Abbrechen"),
                            mithril("button", { class: "btn btn--primary ml1", onclick: function () { return (state.show = false); } }, "Verbindlich buchen")) })));
        }
    };
    ...
    var container = document.querySelector('.example-app');
    container && mithril.mount(container, Root);
